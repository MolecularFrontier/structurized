...
Project coordinates:
- Parent build: `tech.molecules:structurized:0.3.6`
- Core module: `tech.molecules:structurized-core:0.3.6`
- AI inspection module: `tech.molecules:structurized-ai-core:0.3.6`
- AI Prism bridge module: `tech.molecules:structurized-ai-prism:0.3.6`
- AI MCP adapter module: `tech.molecules:structurized-ai-mcp:0.3.6`
- Analytics module: `tech.molecules:structurized-analytics:0.3.6`
- Workbench module: `tech.molecules:structurized-workbench:0.3.6`
...
- `java -jar structurized-ai-mcp/target/structurized-ai-mcp-0.3.6-standalone.jar` – launch the stdio MCP adapter
- `mvn -pl structurized-prismlite-app -am -Dgpg.skip=true -DskipTests package` – build the shared PrismLite + MCP desktop jar
- `java -jar structurized-prismlite-app/target/structurized-prismlite-app-0.3.6-standalone.jar [--session-id=workspace] [--record-agent-trace=/path/session.jsonl | --replay-agent-trace=/path/session.jsonl] [dataset]` – launch PrismLite and stdio MCP over one managed session
