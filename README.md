...
Project coordinates:
- Parent build: `tech.molecules:structurized:0.3.3-SNAPSHOT`
- Core module: `tech.molecules:structurized-core:0.3.3-SNAPSHOT`
- AI inspection module: `tech.molecules:structurized-ai-core:0.3.3-SNAPSHOT`
- AI Prism bridge module: `tech.molecules:structurized-ai-prism:0.3.3-SNAPSHOT`
- AI MCP adapter module: `tech.molecules:structurized-ai-mcp:0.3.3-SNAPSHOT`
- Analytics module: `tech.molecules:structurized-analytics:0.3.3-SNAPSHOT`
- Workbench module: `tech.molecules:structurized-workbench:0.3.3-SNAPSHOT`
...
- `java -jar structurized-ai-mcp/target/structurized-ai-mcp-0.3.3-SNAPSHOT-standalone.jar` – launch the stdio MCP adapter
- `mvn -pl structurized-prismlite-app -am -Dgpg.skip=true -DskipTests package` – build the shared PrismLite + MCP desktop jar
- `java -jar structurized-prismlite-app/target/structurized-prismlite-app-0.3.3-SNAPSHOT-standalone.jar [--session-id=workspace] [dataset]` – launch PrismLite and stdio MCP over one managed session
